...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        // Normalizan la velocidad del sonido para que sea diferente a la del Update
        private float footstepTimer = 0f;
        private float footstepInterval = 0.5f;

        [Header("Player")]
        [Tooltip("Strafing velocity")]
        ...
        private void Move()
        {
            ...
            // Rlacionado al sonido del movimiento del personaje

            bool isWalking = _input.move != Vector2.zero && Grounded && _speed > 0.1f;
            ...
            {
                footstepTimer = 0f; // Reiniciar si deja de caminar
            }
        }
        ...
        {
            Debug.Log("REsproduccion de sonido desde OnFootStep");
            StartCoroutine(AudioManager.Instance.Play("Pasos"));
        ...
        //     if (animationEvent.animatorClipInfo.weight > 0.5f)
        //     {
        //         StartCoroutine(AudioManager.Instance.Play("Salto"));
        //     }
        // }
    }
}